...
extension CachedNotificationByIndex on IsarCollection<CachedNotification> {
  Future<CachedNotification?> getByServerId(String serverId) {
    return getByIndex(r'serverId', [serverId]);
  }

  CachedNotification? getByServerIdSync(String serverId) {
  ...
  Future<List<CachedNotification?>> getAllByServerId(
      List<String> serverIdValues) {
    final values = serverIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'serverId', values);
  }

  List<CachedNotification?> getAllByServerIdSync(List<String> serverIdValues) {
    final values = serverIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByServerId(CachedNotification object) {
    return putByIndex(r'serverId', object);
  }

  Id putByServerIdSync(CachedNotification object, {bool saveLinks = true}) {
    return putByIndexSync(r'serverId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByServerId(List<CachedNotification> objects) {
    return putAllByIndex(r'serverId', objects);
  }

  List<Id> putAllByServerIdSync(List<CachedNotification> objects,
      {bool saveLinks = true}) {
...
extension CachedNotificationQueryProperty
  ...
  QueryBuilder<CachedNotification, String, QQueryOperations> messageProperty() {
    return QueryBuilder.apply(this, (query) {
